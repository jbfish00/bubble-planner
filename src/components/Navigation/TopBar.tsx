    ...
    <>
      <header className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 px-5 py-4 flex items-center justify-between safe-area-top relative z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            className="flex items-center gap-2 px-4 py-2.5 rounded-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
              ...
              >
                <div className="grid grid-cols-4">
                  {views.map(v => (
                    <button
                      key={v.mode}
                      className={`flex flex-col items-center gap-2 py-6 px-4 transition-colors ${
                        viewMode === v.mode
